...
const FALLBACK_CATALOG: CatalogItem[] = [
  ...
  { provider: "ramp", label: "Ramp", description: "Modern spend platform: corporate cards, bill pay, procurement, and job-cost fields. Owns itemized spend data Plaid cannot see.", category: "banking", authType: "api-token", tier: 1, built: false, callbackPath: null,
    fields: [{ key: "apiKey", label: "API Key", placeholder: "Ramp API key (server-side)", secret: true }, { key: "businessId", label: "Business ID", placeholder: "Ramp business id", secret: false }] },
  { provider: "brex", label: "Brex", description: "Corporate cards and expense/spend management for scale-ups and mid-market. Holds its own itemized spend data.", category: "banking", authType: "api-token", tier: 1, built: false, callbackPath: null,
    fields: [{ key: "apiToken", label: "API Token", placeholder: "Brex API token", secret: true }, { key: "companyId", label: "Company ID", placeholder: "Brex company id", secret: false }] },
  { provider: "jpmorgan-chase", label: "JPMorgan Chase / J.P. Morgan Commercial Card", description: "#1 Visa and Mastercard commercial-card issuer in the U.S. Corporate card spend, controls, and reporting for larger companies.", category: "banking", authType: "api-token", tier: 1, built: false, callbackPath: null,
    fields: [{ key: "apiKey", label: "API Key", placeholder: "J.P. Morgan commercial card API key", secret: true }, { key: "accountId", label: "Account ID", placeholder: "Commercial card account id", secret: false }] },
  { provider: "american-express", label: "American Express", description: "Extremely common corporate-card program: cards, expense management, B2B payments, and central-bill capabilities.", category: "banking", authType: "api-token", tier: 1, built: false, callbackPath: null,
    fields: [{ key: "apiKey", label: "API Key", placeholder: "Amex corporate card API key", secret: true }, { key: "accountId", label: "Account ID", placeholder: "Amex corporate program/basic card id", secret: false }] },
  { provider: "bank-of-america", label: "Bank of America", description: "Major commercial/business banking relationship bank with corporate cards and spend data.", category: "banking", authType: "api-token", tier: 1, built: false, callbackPath: null,
    fields: [{ key: "apiKey", label: "API Key", placeholder: "BofA commercial card API key", secret: true }, { key: "accountId", label: "Account ID", placeholder: "BofA commercial card account id", secret: false }] },
  { provider: "capital-one", label: "Capital One", description: "Important business/commercial card ecosystem for small and mid-market operators.", category: "banking", authType: "api-token", tier: 2, built: false, callbackPath: null,
    fields: [{ key: "apiKey", label: "API Key", placeholder: "Capital One commercial card API key", secret: true }, { key: "accountId", label: "Account ID", placeholder: "Capital One commercial card account id", secret: false }] },
  { provider: "citi", label: "Citi", description: "Major commercial-card/banking relationship for middle-market and enterprise operators.", category: "banking", authType: "api-token", tier: 2, built: false, callbackPath: null,
    fields: [{ key: "apiKey", label: "API Key", placeholder: "Citi commercial card API key", secret: true }, { key: "accountId", label: "Account ID", placeholder: "Citi commercial card account id", secret: false }] },
  { provider: "wells-fargo", label: "Wells Fargo", description: "Important middle-market/commercial banking presence with corporate card data.", category: "banking", authType: "api-token", tier: 2, built: false, callbackPath: null,
    fields: [{ key: "apiKey", label: "API Key", placeholder: "Wells Fargo commercial card API key", secret: true }, { key: "accountId", label: "Account ID", placeholder: "Wells Fargo commercial card account id", secret: false }] },
